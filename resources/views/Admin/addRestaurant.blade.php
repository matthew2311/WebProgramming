        ...
        <div>
            <form action="{{ route('addRestaurantLogic') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('restaurant_name') is-invalid @enderror" id="" name="restaurant_name" value="{{ old('restaurant_name') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea type="long text" class="form-control @error('restaurant_address') is-invalid @enderror" id="" rows="3" name="restaurant_address">{{ old('restaurant_address') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <select id="inputState" class="form-select @error('restaurant_city') is-invalid @enderror" name="restaurant_city">
