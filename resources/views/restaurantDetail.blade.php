    ...
    @foreach ($restaurant_detail as $rd)
        <div class="card mx-auto my-auto mt-5" style="width: 1000px; background-color: #EF8354">
            ...
            @if ($rd->restaurant->restaurant_whatsapp_link != NULL)
                <a href="{{$rd->restaurant->restaurant_whatsapp_link}}" target="_blank" class="btn btn-success"><i class="bi bi-whatsapp"></i> WhatsApp</a>
            @endif
            @if ($rd->restaurant->restaurant_instagram_link != NULL)
                <a href="{{$rd->restaurant->restaurant_instagram_link}}" target="_blank" class="btn btn-light"><i class="bi bi-instagram"></i> Instagram</a>
            @endif
            @if ($rd->restaurant->restaurant_tiktok_link != NULL)
                <a href="{{$rd->restaurant->restaurant_tiktok_link}}" target="_blank" class="btn btn-dark"><i class="bi bi-tiktok"></i> TikTok</a>
            @endif
            ...
            @if ($rd->restaurant_grabfood != NULL)
                <a href="{{$rd->restaurant->restaurant_grabfood}}" target="_blank" class="btn btn-success">Grab Food</a>
            @endif
